...
BENCHMARK_NAME="local_dht_benchmark_par_fetch_k${KVALUE}_a${ALPHA}"
...
do
	...
	do
		...
		$cmd ./benchmark/benchmark_api.py --log_db "$BENCHMARK_NAME/$x.db" --num_rounds $ITERATIONS --do_fetch True --num_fetches $NUM_FETCH --num_threads $NUM_THREADS
