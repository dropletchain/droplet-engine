...
from taloskademlia.protocol import KademliaProtocol
from taloskademlia.utils import deferredDict, digest
from taloskademlia.storage import ForgetfulStorage
from taloskademlia.node import Node
from taloskademlia.crawling import ValueSpiderCrawl
from taloskademlia.crawling import NodeSpiderCrawl
...
class Server(object):
    ...
    def __init__(self, ksize=20, alpha=3, id=None, storage=None):
        ...
        Args:
            ...
            storage: An instance that implements :interface:`~taloskademlia.storage.IStorage`
        """
        self.ksize = ksize
        self.alpha = alpha
