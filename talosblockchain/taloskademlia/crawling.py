...
from taloskademlia.utils import deferredDict
from taloskademlia.node import Node, NodeHeap
...
class SpiderCrawl(object):
    ...
    def __init__(self, protocol, node, peers, ksize, alpha):
        ...
        Args:
            protocol: A :class:`~taloskademlia.protocol.KademliaProtocol` instance.
            node: A :class:`~taloskademlia.node.Node` representing the key we're looking for
            peers: A list of :class:`~taloskademlia.node.Node` instances that provide the entry point for the network
